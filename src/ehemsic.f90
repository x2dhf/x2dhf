...
subroutine ehemsic (psi,pot,wgt2,wk1,wk0)
  ...
  real (PREC) ::  const13,const23,const43,const53,cxlda,cxlsd,esic1,esic2,w

  real (PREC), dimension(*) ::  psi,pot,wgt2,wk0,wk1
  real (PREC), external :: dot

  parameter (const13=1.0_PREC/3.0_PREC,const23=2.0_PREC/3.0_PREC,const43=4.0_PREC/3.0_PREC,&
       const53=5.0_PREC/3.0_PREC)

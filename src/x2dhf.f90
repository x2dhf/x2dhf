...
!      equivalence(datetimex,str(1))
      ...
      real (PREC), dimension(:), allocatable :: cw_orb_add,cw_coul_add,cw_exch_add,cw_suppl_add,cw_sctch_add,work4_add
...
!     dynamic allocation of memory acccording to the current case 
      ...
      allocate(work4_add(ngrid*ngrid),stat=error)
...
! c  perform scf
       !       call  doSCF (cw_sor_add,cw_orb_add,cw_coul_add,cw_exch_add,cw_suppl_add,cw_sctch_add,work4_add)
       ! FIXME

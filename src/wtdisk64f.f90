...
module wtdisk64f_m
  implicit none
contains
  subroutine wtdisk64f (cw_orb,cw_coul,cw_exch,i8tmp,r8l60,r8l1200,r8l3660,r8mxsize)
    use params
    use discret
    use memory
    use scf
    ...
    write(i8out21,formfp64,err=1020) (r8l60(i),i=1,maxorb)
    ...
    write(i8out21,formfp64,err=1020) (r8l3660(i),i=1,maxorb*maxorb)

    do i=1,20*maxorb
       r8l1200(i)=cmulti(i)
    enddo
    !    write(i8out21,err=1020) cmulti
    write(i8out21,formfp64,err=1020) (r8l1200(i),i=1,20*maxorb)

    do i=1,maxorb*(maxorb+1)
       r8l3660(i)=excdi(i)
    enddo
    !    write(i8out21,err=1020) excdi
    write(i8out21,formfp64,err=1020) (r8l3660(i),i=1,maxorb*(maxorb+1))
       ...
       if (iform.eq.2.or.iform.eq.3) then
          ...
          do iorb1=1,norb
             do iorb2=iorb1,norb
                ...
                call writea64f(i8out23,i8tmp1,r8mxsize,ierr)
...
1000 continue
    ...
    ! FIXME
1020 continue
    write(*,*) 'wtdiski64f: error encountered when writing an extension to orbital file'
    write(*,*) '      '
    stop 'wtdiski64f'
1050 format(1x,'... writing functions to disk (i64f) ...')
1070 format(//1x,'error! can not write data to disk'//)
    !1080 format(//1x,'error! can not write data to disk'//)
  end subroutine wtdisk64f
end module wtdisk64f_m

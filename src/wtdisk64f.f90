...
subroutine wtdisk64f (cw_orb,cw_coul,cw_exch,i8tmp,r8l60,r8l1200,r8l3660,r8mxsize)
  ...
  implicit none
  integer*8 :: i,ierr,iorb1,iorb2,ioffset,j,k
  ...
  do i=1,norb
     ...
     enddo
     call writea64f(iout21,i8tmp1,r8mxsize,ierr)
     if (ierr.ne.0) then
  ...
  do i=1,norb
     ...
     enddo
     call writea64f(iout22,i8tmp1,r8mxsize,ierr)
     ...
     if (iform.eq.2.or.iform.eq.3) then
        ...
        do iorb1=1,norb
           do iorb2=iorb1,norb
              ...
              call writea64f(iout23,i8tmp1,r8mxsize,ierr)

...
subroutine orbSOR (iorb,cw_sor,psi,pot,excp,b,d,e,f0,f1,f2,f4,wgt2, &
     ...
     do ig=1,i1ng(iorb)
        ...
        if (i1ng(iorb).eq.1) then 
           ...
           do itr2=1,maxsororb(iorb)	  		
              call sor (wk2,lhs(ioffs1),rhs(ioffs1),b(ioffs1),d(ioffs1),cw_sor(iadext(ig)),cw_sor(iadnor(ig)), &
           ...
           !            multigrid case (obsoleted in version 2.0)
           if (ig.eq.1) then 
              !               icase=2
              ifill=2
              ngrd1 =ingr2(1,ig)
              ...
              do itr2=1,maxsororb(iorb)
                 call sor (wk2,lhs(ioffs1),rhs(ioffs1),b(ioffs1),d(ioffs1),cw_sor(iadext(ig+ngrids)), &
